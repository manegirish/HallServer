  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Standard Delivery</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
			...
			<?php
				$description="";
				$sel=mysqli_query($con,"select description from about_us where type='standard_delivery'");
			...
			?>
				<form role="form" name="my_form" id="my_form" method="POST">
					  ...
					  <input type="hidden" id="action" name="action" value="add_standard_delivery"/>
