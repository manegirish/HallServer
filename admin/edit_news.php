    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
			...
			$sq=mysqli_query($con,"select * from news where news_id=".$_GET['id']."");
				...
				<form role="form" name="my_form" id="my_form" method="POST">
					  <div class="box-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="description" name="description" placeholder="Enter some description"><?php echo $row['description']; ?></textarea>
							<div id="error_description" style="display:none" class="error"></div>
						</div>
						
						<div class="form-group">
									<label for="product_old_image">Old Images</label><br/>
									<?php
										if($row['image_path']!="")
										{
									?>			<div class="pull-left" id="proimg">
												<img class="form-control"  src="<?php echo "../images/".$row['image_path']?>" style="height:200px;width:200px;float:left"/>
												</div>
									<?php
										}
						...
						<div class="form-group">
							<label for="product_image">Change Images</label>
		...
		$.ajax({
			...
			success: function (dataofconfirm) {
				if($.trim(dataofconfirm)=='1')
				{
					...
					$("#msg").show();
					$("#msg").html("News updated Successfully.");
